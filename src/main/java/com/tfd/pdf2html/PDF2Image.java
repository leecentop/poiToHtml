...
public class PDF2Image {
    ...
    public static void pdf2Image(File pdfFile, String htmlDir, String imgDir, String imgWebPath, String password, HttpServletResponse res) throws IOException {
...
//                    BufferedImage image = reader.renderImageWithDPI(i, 130, ImageType.RGB);
        ...
        byte[] body = File2byte.getBytes(pdfFile);
