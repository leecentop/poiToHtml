...
public class Excel2Html {
    public static void xls2Html(File file, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws Exception {
        if (file.getName().endsWith("xlsx")) {
            xlsx2Html(file, htmlDir, imgDir, imgWebPath,res);
        } else if (file.getName().endsWith("xls")) {
            xls2html(file, htmlDir, imgDir, imgWebPath,res);
        } else {
            throw new RuntimeException("file not xls!");
        }
    }

    private static void xlsx2Html(File xlsFile, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws Exception {
    ...
    private static void xls2html(File xlsFile, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws Exception {
