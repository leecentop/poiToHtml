...
public class Word2Html {
    ...
    public static void word2Html(File file, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws Exception {
        if (file.getName().endsWith("docx")) {
            docx2Html(file, htmlDir, imgDir, imgWebPath,res);
        } else if (file.getName().endsWith("doc")) {
            doc2Html(file, htmlDir, imgDir, imgWebPath,res);
        } else {
            throw new RuntimeException("file not doc!");
        }
    }

    private static void docx2Html(File docFile, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws IOException {
        //生成html文件
        ...
        // html中图片的路径
//        options.URIResolver(new BasicURIResolver(imgWebPath + File.separator));
...
//        options.URIResolver(new BasicURIResolver("image"));
        ...
        xhtmlConverter.convert(document, res.getWriter(), options);
...
//        xhtmlConverter.convert(document, res.getWriter(), options);
    ...
    private static void doc2Html(File docFile, String htmlDir, String imgDir, final String imgWebPath, HttpServletResponse res) throws Exception {
