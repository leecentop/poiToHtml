...
public class PPT2Image {
    public static void ppt2Html(File file, String htmlDir, String imgDir, String imgWebPath, HttpServletResponse res) throws Exception {
        if (file.getName().endsWith("pptx")) {
            pptx2Image(file, htmlDir, imgDir, imgWebPath,res);
        } else if (file.getName().endsWith("ppt")) {
            ppt2Image(file, htmlDir, imgDir, imgWebPath,res);
        } else {
            throw new RuntimeException("file not ppt!");
        }
    }

    private static void ppt2Image(File pptFile, String htmlDir, String imgDir, String imgWebPath,HttpServletResponse res) throws Exception {
...
//                graphics.setPaint(Color.white);
    ...
    private static void pptx2Image(File pptFile, String htmlDir, String imgDir, String imgWebPath,HttpServletResponse res) throws Exception {
        FileInputStream is = new FileInputStream(pptFile);
